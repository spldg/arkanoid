...
export class StartMenuFrame extends PIXI.Container {
    private uiNarrowTexture = PIXI.Loader.shared.resources.game.textures?.['startmenu_ui_narrow.png']
    private uiWideTexture = PIXI.Loader.shared.resources.game.textures?.['startmenu_ui_wide.png']
    private cornerTexture = PIXI.Loader.shared.resources.game.textures?.['startmenu_ui_corner.png']
    private bgTexture = PIXI.Loader.shared.resources.game.textures?.['startmenu_ui_bg.png']
